...
extern DECLARE_GLOBAL_DATA_PTR ;
...
unsigned long get_board_sys_clk(ulong dummy)
{
	...
	#define MPC85xx_GPIO_OFFSET  GPIO_ADDR+CONFIG_SYS_MPC85xx_GPIO_OFFSET
	//volatile ccsr_gpio_t *pgpio = (void *)(CONFIG_SYS_MPC85xx_GPIO_ADDR);
	
	//Вроде правильно работает отдаёт ревизию платы! 01 REV_C
	 volatile ccsr_gpio_t *pgpio = (void *)(MPC85xx_GPIO_OFFSET);  
...
//#define SYSCLK_66	 66666666
	  ...
	  //return (MHZ50 + 8) / 16;
        return (SYSCLK_66 + 8) / 16; 

#else
      //return (gd->bus_clk + 4UL)/8UL;
       //return (MHZ50 + 4UL)/8UL;
       return (SYSCLK_66 + 4UL)/8UL;
#endif
}
